---
title: "Listeners"
description: "Learn how to use listeners in your application using the glcloud python sdk."
---
...
<Accordion title="Additional information about this decorator">
    ...
    only a `response` parameter (of type `glcloud.http.Response`) will
    be returned.
</Accordion>
<Tip>
...
The "request listeners" do pretty much the same thing. But here you use the [Client], and the return of all endpoints is `glcloud.http.Response` objects.
...
_This implementation was inspired by a [suggestion](https://github.com/glcloudofc/wrapper-api-py/pull/1) made by [@Mudinho](https://github.com/zRickz), thank you for contributing._