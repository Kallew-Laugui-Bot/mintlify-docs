...
<Tabs>
    <Tab title="Using Client">
        ...
        client = gl.Client(api_key='API KEY')
...
<Tabs>
    ...
    <Tab title="Using Application">
        ...
        <Tab title="Using CLI">
        ````bash
        glcloud app <APP-ID> file-read <PATH>
        ````
    </Tab>
</Tabs>
    ...
    <Tab title="Using Client">
        ...
        async def example():
            await client.create_app_file(
                app_id='application_id', path='/file.txt', file=gl.File('file.txt')
            )
        ````
    </Tab>
    <Tab title="Using Application">
        ...
        async def example():
            ...
            await app.create_file(path='/file.txt', file=gl.File('file.txt'))
        ````
    </Tab>
        <Tab title="Using CLI">
        ````bash
        glcloud app <APP-ID> file-create <FILE>
        ````
    </Tab>
</Tabs>
...
<Tabs>
    ...
    <Tab title="Using Application">
        ...
        <Tab title="Using CLI">
        ````bash
        glcloud app <APP-ID> file-delete <PATH>
        ````
    </Tab>
</Tabs>
