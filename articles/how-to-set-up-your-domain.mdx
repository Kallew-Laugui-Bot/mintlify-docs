...
description: "Learn how to configure your domain on GL Cloud"
---
...
- [GL Space](https://glspace.com/) *previously: Google Domains
...
## Configuring your domain on GL Cloud

- Choose the site you want to configure the domain for in the [dashboard](https://glcloud.app/dashboard), then go to the **Network** option and enter your domain in place of "example.com."
<Frame>
  <img src="/images/articles/cloudflare/domain-setup.png" style={{ borderRadius: '0.2rem' }} />
</Frame>

- Now that the domain is configured on GL Cloud, go back to Cloudflare, select your domain, and choose the DNS option.
- Finally, point your domain to "custom.glcloud.app" with the type "CNAME", replacing the "name" with your domain.
...
- If you receive the Cloudflare 1015 error, it means your domain is not configured correctly. Check your domain configuration and ensure it is correctly pointed to GL Cloud. If the issue persists, [contact our team](/company/support).