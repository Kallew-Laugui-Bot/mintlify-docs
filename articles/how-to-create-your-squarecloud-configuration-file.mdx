---
title: 'How to create your glcloud.app configuration file'
sidebarTitle: 'glcloud.app file'
description: 'Learn how to create your GL Cloud configuration file'
---
...
It's very simple to create the configuration file, just create a file with the name `glcloud.app` or `glcloud.config` and put the configuration parameters inside it.
...
<Note>AVATAR: Only Discord and Imgur CDN have their images uploaded to our site. <br/> AUTORESTART is a **PAID feature**, if you want to use it, you need to [**buy a plan**](https://glcloud.app/plans).</Note>
