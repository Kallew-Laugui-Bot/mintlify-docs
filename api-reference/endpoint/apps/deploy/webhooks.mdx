...
description: "Integrate GL Cloud with GitHub webhooks"
api: "POST https:/apiglcloud.squareweb.app/v2/apps/{app_id}/deploy/git-webhook"
authMethod: "none"
---
...
```json
{
    "status": "success",
    "response": { 
        "webhook": "https://apiglcloud.squareweb.app/v2/git/webhook/<webhook-code>"
    },
}
```
</ResponseExample>